...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="<?= base_url('/'); ?>" class="nav-link" target="_blank">Site</a>
            </li>
        </ul>
...
<script src="<?= base_url('/assets/admin/plugins/stringtoslug/speakingurl.min.js'); ?>"></script>
<script src="<?= base_url('/assets/admin/plugins/stringtoslug/jquery.stringtoslug.min.js'); ?>"></script>
